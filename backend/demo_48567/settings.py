"""
Django settings for demo_48567 project.
...
WSGI_APPLICATION = 'demo_48567.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Demo Support <support@demo-48567.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_48567 API",
    "DESCRIPTION": "API documentation for demo_48567 App",
    "VERSION": "v1",
}
